...
{
    [TestClass]
    public class CreateLead : TestBase
    {
        ...
        public void CreateLead_Pass()
        {
            try
            {
                ...
                using (var xrmApp = new XrmApp(client))
                {
                    ...
                    AddScreenShot(client, "After OpenSubArea: Sales/Leads");

                    xrmApp.CommandBar.ClickCommand("New");
                    AddScreenShot(client, "After ClickCommand: New");

                    xrmApp.Entity.SetValue("firstname", TestSettings.GetRandomString(5, 15));
                    AddScreenShot(client, "After SetValue: firstname");

                    xrmApp.Entity.SetValue("subject", TestSettings.GetRandomString(5, 15));
                    xrmApp.Entity.SetValue("lastname", "Mustermann");
                    xrmApp.Entity.SetValue("emailaddress1", "test@gmx.de");
                    xrmApp.Entity.SetValue("jobtitle", "Field Agent");
